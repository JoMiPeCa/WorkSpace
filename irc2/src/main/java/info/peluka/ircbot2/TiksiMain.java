...
public class TiksiMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Configuration<PircBotX> config = new Configuration.Builder()
                .setName("Tiksi") //Nick of the bot. CHANGE IN YOUR CODE
                ...
                .addAutoJoinChannel("#UPA") //Join #pircbotx channel on connect
                .addAutoJoinChannel("#podelba")
                .addAutoJoinChannel("#Tiksi")
                .addAutoJoinChannel("#PRC")
                .addAutoJoinChannel("#Voters")
                .addAutoJoinChannel("#faa.pab_mac")
