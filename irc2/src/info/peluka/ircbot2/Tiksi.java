...
import info.peluka.ircbot2.database.model.ChannelDAO;
import info.peluka.ircbot2.database.model.IrcUser;
import info.peluka.ircbot2.database.model.IrcUsersDAO;
...
//                }
    ...
    public void regOP(Channel channel, String nick) {
        IrcUser ircUser = IrcUsersDAO.getIrcUserByNickname(nick);
        if (ircUser != null) {
            info.peluka.ircbot2.database.model.Channel channel1 = ChannelDAO.getChannel(channel.getName());
